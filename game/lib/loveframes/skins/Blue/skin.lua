...
return function(loveframes)
    ...
    skin.name = "Blue"
    skin.author = "Nikolai Resokav modify by Pevalcar"
    skin.version = "1.0"

    local dark_green = {0.2, 0.4, 0.2, 1} -- Verde oscuro para bordes
    local medium_green = {0.4, 0.7, 0.4, 1} -- Verde medio para elementos interactivos
    local light_green = {0.8, 0.95, 0.8, 1} -- Verde claro para fondos
    local bright_green = {0.5, 0.9, 0.5, 1} -- Verde brillante para highlights
    local brown_green = {0.6, 0.7, 0.4, 1}

    local bordercolor = dark_green
    ...
    -- Frame
    skin.controls.frame_body_color = light_green
    skin.controls.frame_name_color = {0.1, 0.3, 0.1, 1}
    skin.controls.frame_name_font = skin.controls.smallfont

    -- Botón
    skin.controls.button_text_down_color = {1, 1, 1, 1}
    skin.controls.button_text_nohover_color = {0.1, 0.3, 0.1, 0.9}
    skin.controls.button_text_hover_color = {1, 1, 1, 1}
    skin.controls.button_text_nonclickable_color = {0.3, 0.4, 0.3, 0.6}

    -- ImageButton
    skin.controls.imagebutton_text_down_color = {1, 1, 1, 1}
    skin.controls.imagebutton_text_nohover_color = {0.9, 0.95, 0.9, 0.9}
    skin.controls.imagebutton_text_hover_color = {1, 1, 1, 1}

    -- CloseButton
    skin.controls.closebutton_body_down_color = medium_green
    skin.controls.closebutton_body_nohover_color = light_green
    skin.controls.closebutton_body_hover_color = bright_green

    -- ProgressBar
    skin.controls.progressbar_body_color = light_green
    skin.controls.progressbar_text_color = {0.1, 0.3, 0.1, 1}
    skin.controls.progressbar_bar_color = medium_green

    -- Listas y Paneles
    skin.controls.list_body_color = {0.85, 0.93, 0.8, 1}
    skin.controls.scrollarea_body_color = {0.8, 0.9, 0.8, 1}
    skin.controls.panel_body_color = {0.85, 0.93, 0.8, 1}
    skin.controls.tabpanel_body_color = {0.85, 0.93, 0.8, 1}

    -- Pestañas
    skin.controls.tab_text_nohover_color = {0.2, 0.4, 0.2, 1}
    skin.controls.tab_text_hover_color = {1, 1, 1, 1}

    -- Multichoice
    skin.controls.multichoice_body_color = light_green
    skin.controls.multichoice_text_color = {0.1, 0.3, 0.1, 1}
    skin.controls.multichoicelist_body_color = {0.85, 0.93, 0.8, 0.95}
    skin.controls.multichoicerow_body_nohover_color = light_green
    skin.controls.multichoicerow_body_hover_color = medium_green
    skin.controls.multichoicerow_text_nohover_color = {0.1, 0.3, 0.1, 1}

    -- Tooltip
    skin.controls.tooltip_body_color = {0.95, 1, 0.95, 1}

    -- TextInput
    skin.controls.textinput_body_color = {0.95, 1, 0.95, 1}
    skin.controls.textinput_highlight_bar_color = medium_green
    skin.controls.textinput_text_placeholder_color = {0.4, 0.6, 0.4, 1}

    -- Slider
    skin.controls.slider_bar_outline_color = {0.7, 0.8, 0.7, 1}

    -- Checkbox y Radiobutton
    skin.controls.checkbox_check_color = medium_green
    skin.controls.radiobutton_check_color = medium_green
    skin.controls.radiobutton_inner_border_color = dark_green

    -- Columnas
    skin.controls.columnlist_body_color = light_green
    skin.controls.columnlistarea_body_color = light_green
    skin.controls.columnlistrow_body1_color = {0.9, 0.95, 0.9, 1}
    skin.controls.columnlistrow_body2_color = {0.85, 0.93, 0.8, 1}
    skin.controls.columnlistrow_body_selected_color = medium_green
    skin.controls.columnlistrow_body_hover_color = bright_green
    skin.controls.columnlistrow_text_color = {0.2, 0.4, 0.2, 1}

    -- Fondo modal
    skin.controls.modalbackground_body_color = {0.1, 0.2, 0.1, 0.6}

    -- Números de línea
    skin.controls.linenumberspanel_text_color = {0.4, 0.6, 0.4, 1}
    skin.controls.linenumberspanel_body_color = light_green

    -- Grid
    skin.controls.grid_body_color = {0.8, 0.9, 0.8, 1}

    -- Menú
    skin.controls.menu_body_color = light_green
    skin.controls.menuoption_body_hover_color = medium_green
    skin.controls.menuoption_text_color = {0.2, 0.4, 0.2, 1}
